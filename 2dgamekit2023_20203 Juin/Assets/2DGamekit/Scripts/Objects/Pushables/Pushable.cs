...
namespace Gamekit2D
{
    ...
    public class Pushable : MonoBehaviour
    {
        ...
        public void StartPushing()
        {
            ...
            FMODUnity.RuntimeManager.PlayOneShot("event:/Interactables/PushClayBoxStart", transform.position);
        }
        ...
        public void EndPushing()
        {
            ...
            pushableAudioSource.Play();
            FMODUnity.RuntimeManager.PlayOneShot("event:/Interactables/PushClayBoxEnd", transform.position);
        }
        ...
        public void Move (Vector2 movement)
        {
            ...
            if(!pushableAudioSource.isPlaying)
            {
                ...
                pushableAudioSource.Play();
                FMODUnity.RuntimeManager.PlayOneShot("event:/Interactables/PushClayBoxLoop", transform.position);
            }
        }
