...
namespace Gamekit2D
{
    ...
    public class PlayerCharacter : MonoBehaviour
    {
        ...
        protected void SpawnBullet()
        {
            ...
            FMODUnity.RuntimeManager.PlayOneShot("event:/Ellen/Attacks/Ranged/EllenRangedAttack", GetComponent<Transform>().position);
        }
        ...
        public bool CheckForGrounded()
        {
            ...
            if (grounded)
            {
                ...
                {//only play the landing sound if falling "fast" enough (avoid small bump playing the landing sound)
                    ...
                    //FMODUnity.RuntimeManager.PlayOneShot("event:/Ellen/Locomotion/EllenFootstepLand", transform.position);//                      
                }
            }
            else
        ...
        public void OnHurt(Damager damager, Damageable damageable)
        {
            ...
            FMODUnity.RuntimeManager.PlayOneShot("event:/Ellen/Emotes/EllenEmotesEffort", GetComponent<Transform>().position);
